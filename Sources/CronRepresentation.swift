...
enum CronField: Int {
    ...
    private static let fieldCheckers: [FieldCheckerInterface] = [MinutesField(), HoursField(), DayOfMonthField(), MonthField(), DayOfWeekField(), YearField()]
